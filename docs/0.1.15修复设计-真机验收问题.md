...
| 0.1.4 冻结案 | v3 复核 L86/L129：用户见纯 `initializing…`（非「webview API unavailable」）→ 当年判「页面 JS 未执行」；v4 烤 src（f859313，0.1.5）**救显示未救脚本** | `docs/面板卡Initializing根因分析-v3-0.1.4真机复核.md` |
